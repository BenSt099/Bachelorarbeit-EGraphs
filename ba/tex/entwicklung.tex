...
\begin{lstlisting}[language=Python, caption=Auszug aus der Datei \textit{EGraphService.py}, label={lst:serviceinit}]
...
Die Dokumentation wurde unabhängig mit dem Framework \textit{Docusaurus} erstellt. Abbildung~\ref{fig:docs} zeigt die Startseite der Dokumentation.
...
% \caption{Dokumentation der Anwendung}
% \label{fig:docs}
% \end{figure}
% \newpage
