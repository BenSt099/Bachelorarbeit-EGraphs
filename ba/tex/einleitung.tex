...
\noindent {\itshape Kapitel \ref{sec:entwicklung} - Entwicklung der Anwendung}

\noindent {\itshape Kapitel \ref{sec:entscheidungenundprobleme} - Entscheidungen und Probleme}

\noindent {\itshape Kapitel \ref{sec:reflektion} - Reflektion}

\noindent {\itshape Kapitel \ref{sec:fazit} - Fazit und Ausblick}
