...
\begin{itemize}
    ...
    die in vielen Situationen Anwendung finden kann. Sie ist außerdem bekannt und wird auf allen gängigen Plattformen genutzt, sodass die Plattformunabhängigkeit garantiert ist. 
...
\begin{itemize}
    ...
    Daher kann auf die Interaktion mit \textit{Graphviz} über ein CLI verzichtet werden.
    ...
    mit einer entsprechenden Bibliothek wie \textit{d3-graphviz}~\footnote{\hspace{1.5mm}\url{https://github.com/magjac/d3-graphviz}}, in der Lage ist, einen E-Graph in dem \textit{DOT}-Format entgegen zu nehmen
...
\begin{itemize}
    \item Es sind umfangreiche GUI-Bibliotheken für Python vorhanden, darunter PyQt, PySide oder TKinter. Jede von ihnen weist jedoch plattformspezifische Probleme und Einschränkungen auf.
...
Das Testing-Framework \textit{pytest} ist sehr bekannt, verbreitet und zeichnet sich vor allem durch seine Unkompliziertheit aus.
