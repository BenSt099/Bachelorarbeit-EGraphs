...
\subsection{Frameworks für die Website}

Zur Erstellung von Websiten gibt es eine große Anzahl an JavaScript-Frameworks. Unter diesen ein Framework auszuwählen ist zeitintensiv. Zudem sind die meisten Frameworks zu umfangreich oder besitzen weitere
Abhängigkeiten.

% -> docusaurus

% Für die Website wurde kein JavaScript-Framework ausgewählt. Stattdessen wurde auf eine eigene Implementierung gesetzt. Das liegt daran, dass die meisten Frameworks zu umfangreich sind oder weitere
% Abhängigkeiten haben. Zudem ist die Auwahl eines Frameworks aufgrund der Anzahl an zur Verfügung stehenden Frameworks eine zeitintensive Aufgabe.
